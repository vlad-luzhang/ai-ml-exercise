...
def query_openai(prompt: str, model: str = MODEL_NAME, temperature: float = TEMPERATURE) -> str:
...
def evaluate_all() -> None:
    """Evaluate all transcript-note pairs and save structured results to CSV."""
